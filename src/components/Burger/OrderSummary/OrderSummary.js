...
const orderSummary = props => {
  ...
  return (
    <>
      ...
      <p>
        Your total will be <strong>${props.price}</strong>.
      </p>
      <Button classes={'btn btn-primary mr-2'} click={props.continueToCheckout}>
        Checkout
      </Button>
      <Button classes={'btn btn-danger'} click={props.closeModal}>
        Cancel
      </Button>
    </>
  );
